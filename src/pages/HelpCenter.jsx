      ...
      <div className="flex h-full min-h-0 overflow-hidden">
        ...
        <main className="relative min-w-0 flex-1 overflow-y-auto bg-[#f7f9fd] lg:ml-[180px]">
          ...
          <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-10 lg:py-10">
            <section className="overflow-hidden rounded-[28px] border border-[#e3e5f1] bg-white shadow-[0_20px_45px_rgba(15,23,42,0.04)]">
              <div className="bg-[radial-gradient(circle_at_80%_0%,#eeecff_0,transparent_35%),linear-gradient(135deg,#fbfaff_0%,#f7f8ff_100%)] px-6 py-10 sm:px-10 sm:py-14">
                <div className="max-w-3xl">
                  ...
                  <h1 className="mt-5 text-3xl font-extrabold tracking-[-0.05em] text-[#172033] sm:text-5xl">
            ...
            <section className="mt-10">
              <div className="flex items-end justify-between gap-4">
                <div>
                  ...
                  <h2 className="mt-2 text-2xl font-extrabold tracking-[-0.04em] text-[#172033]">
                    Browse by category
                  </h2>
                </div>
                ...
                {categories.map(
                  ({ title, description, count, icon: Icon, color }) => (
                    ...
                    >
                      ...
                      <h3 className="mt-5 text-sm font-extrabold text-[#26324a]">
                        {title}
                      </h3>
                      <p className="mt-2 text-xs leading-5 text-[#71809c]">
                        {description}
