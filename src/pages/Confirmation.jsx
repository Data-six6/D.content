...
import ConfirmationCard from "../components/subscription/checkout/ConfirmationCard.jsx";
...
export default function Confirmation() {
  ...
  if (!order) {
    try {
      order = JSON.parse(localStorage.getItem("meateka_last_order") || "null");
    } catch {
      order = null;
    }
  }
  ...
  return (
    <PageShell
      title="Confirmation"
      description="Your subscription details and receipt are ready."
      showBack
      backTo="/payment"
    >
