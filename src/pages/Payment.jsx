...
import OrderSummary, {
  getOrderTotal,
} from "../components/subscription/checkout/OrderSummary.jsx";
import PaymentForm from "../components/subscription/checkout/PaymentForm.jsx";
...
export default function Payment() {
  ...
  return (
    <PageShell
      title="Payment"
      description="Securely complete your Meateka Pro upgrade."
      showBack
      backTo="/checkout"
    >
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
          <div className="rounded-2xl border border-[#e0e3f0] bg-white p-6 sm:p-8">
            <PaymentForm
            ...
            {failure && (
              <p
                role="alert"
                className="mt-4 rounded-lg bg-[#fff0f1] px-3 py-2 text-sm font-medium text-[#c2415b]"
              >
                {failure}
              </p>
            )}
