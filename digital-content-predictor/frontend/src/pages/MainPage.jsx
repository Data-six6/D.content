...
/**
 * The page is designed at the desktop width below. On any smaller screen
 * (tablet / phone) the whole layout is scaled down so it looks exactly like
 * the computer version, just smaller.
 */
...
const plans = [
  {
    name: "MONTHLY",
    price: "$12.99",
    items: ["7 days free trial, then billed every month as $12.99"],
  },
  {
    name: "BI-ANNUALLY",
    price: "$11.99",
    popular: true,
    items: ["7 days free trial, then billed every month as $11.99"],
  },
  {
    name: "ANNUALLY",
    price: "$9.99",
    items: ["7 days free trial, then billed every month as $9.99"],
  },
];
    ...
    >
      <div
        className={`flex flex-col items-center justify-center rounded-full bg-white ${
          small ? "h-[54px] w-[54px]" : "h-[108px] w-[108px]"
        }`}
      >
...
function MainPage() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-[#fbfaff] text-[#20233d]">
      {/* Everything inside keeps the desktop layout; `zoom` shrinks it to fit. */}
      <div style={{ zoom: scale }}>
        <main>
          ...
          >
            <div className="mx-auto grid max-w-7xl grid-cols-[0.9fr_1.1fr] items-center gap-14 px-8 pb-36 pt-24">
              <div>
                ...
                <h1 className="mt-6 max-w-xl text-6xl font-bold leading-[1.05] tracking-[-0.055em] text-[#20213c]">
                  Smarter Content,
                  <br />
                ...
                <p className="mt-6 max-w-lg text-base leading-7 text-[#74758b]">
                  ...
                  performance before you publish. Stop guessing and start
                  growing with Meateka.
                </p>
            ...
            <div className="mx-auto max-w-7xl px-8 py-28">
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-base leading-7 text-slate-500">
                  Move beyond guesswork. Meateka analyzes, predicts, and
                  optimizes every piece of content before you even hit publish.
                </p>
              </div>

              <div className="mt-14 grid grid-cols-6 gap-5">
                <article className="col-span-4 rounded-3xl border border-[#e6e4f2] bg-[#faf9ff] p-6">
                ...
                <article className="col-span-2 rounded-3xl border border-[#e6e4f2] bg-[#f4f2ff] p-6">
                ...
                <article className="col-span-2 rounded-3xl border border-[#e6e4f2] bg-[#f7fcfb] p-6">
                      ...
                      <div
                        ...
                        className={`rounded-lg border px-2 py-2 text-center text-xs font-bold ${
                          time === "11 AM"
                            ...
                            : "border-[#dcece8] bg-white text-slate-500"
                        }`}
                      >
                        {time}
                      </div>
                ...
                <article className="col-span-2 rounded-3xl border border-[#e6e4f2] bg-[#fffaf4] p-6">
                ...
                <article className="col-span-2 rounded-3xl border border-[#e6e4f2] bg-[#faf9ff] p-6">
                  <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#eeeaff] text-[#6d5ce7]">
                    <LineChart size={19} />
                  </span>
                  ...
                  <div className="mt-5 space-y-3">
                    {[
                      ...
                      >
                        <span className="w-16 font-semibold text-slate-500">
                          {name}
                        </span>
                        ...
                        <b className="w-9 text-right">{value}</b>
                      </div>
                    ))}
                  </div>
                </article>
                ...
                {plans.map((plan) => (
                  <article
                    ...
                    className={`relative rounded-3xl border p-7 ${
                      plan.popular
                        ? "border-[#6d5ce7] bg-[#6d5ce7] text-white shadow-[0_20px_45px_rgba(109,92,231,0.25)]"
                        : "border-[#e4e2f0] bg-white"
                    }`}
                  >
                    {plan.popular && (
                    ...
                    <p
                      className={`text-xs font-bold tracking-[0.18em] ${
                        plan.popular ? "text-white/70" : "text-slate-400"
                      }`}
                    >
                      {plan.name}
                    </p>
                    ...
                    <div
                      className={`my-7 h-px ${
                        plan.popular ? "bg-white/20" : "bg-[#eeeef5]"
                      }`}
                    />
                    <p
                        ...
                        >
                          <Check
                            ...
                            className={`mt-0.5 shrink-0 ${
                              plan.popular ? "text-[#b9f0e6]" : "text-[#6d5ce7]"
                            }`}
                          />
                          <span>{item}</span>
                        </li>
                  ...
                  {faqs.map((question, index) => (
                    <div key={question}>
                      ...
                      >
                        ...
                        <ChevronDown
                          size={17}
                          className={`shrink-0 text-[#6d5ce7] transition-transform ${
                      ...
                      {openFaq === index && (
                        <p className="pb-5 pr-8 text-sm leading-6 text-slate-500">
                          Absolutely. Meateka keeps your plan flexible, with
                          clear billing and support whenever your content
                          strategy changes.
                        </p>
                      )}
                    </div>
          ...
          <section id="about" className="scroll-mt-24 bg-white">
            <div className="mx-auto max-w-7xl px-8 py-28">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <h2 className="mt-3 text-5xl font-bold leading-tight tracking-[-0.04em]">
                  Empowering Creators
                  <br />
                ...
                <p className="mt-5 text-base leading-7 text-slate-500">
                  ...
                  Our mission is to propel the engine that drives high-output
                  planning.
                </p>
              </div>

              <div className="mt-16 grid grid-cols-[1.05fr_0.95fr] items-center gap-16">
                ...
                <div>
                  ...
                  <p className="mt-5 text-sm leading-7 text-slate-500">
                    ...
                    planning shouldn&apos;t feel like manual labor. Our
                    founders, veterans of the content industry, realized that
                    while creativity is boundless, execution often gets bogged
                    down by disorganized workflows and a lack of actionable
                    insights.
                  </p>
                  <p className="mt-4 text-sm leading-7 text-slate-500">
                    We set out to build an AI Content Engine that acts not just
                    as a tool, but as a strategic partner. A platform designed
                    to reduce cognitive load, streamline complex scheduling
                    tasks, and surface the data needed to make informed
                    creative decisions.
                  </p>
                  <p className="mt-4 text-sm leading-7 text-slate-500">
                  ...
                  {teamMembers.map(({ name, role, image }) => (
                    <article key={name} className="text-center">
                      <img
                        src={image}
                        alt={`${name}, ${role}`}
                        className="mx-auto h-28 w-28 rounded-full border-4 border-[#f0edff] object-cover"
                      />
        ...
        <footer className="border-t border-[#e8e6f2] bg-[#fbfaff]">
          <div className="mx-auto flex max-w-7xl flex-row items-center justify-between gap-4 px-8 py-8 text-sm text-slate-500">
            <img src={logo} alt="Meateka logo" className="h-auto w-[120px]" />
