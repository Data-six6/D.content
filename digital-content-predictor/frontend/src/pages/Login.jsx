    ...
    <main className="min-h-screen bg-white text-[#20213c]">
      <div className="grid min-h-screen lg:grid-cols-[minmax(360px,0.9fr)_1.1fr]">
        <section className="relative flex min-h-[360px] flex-col overflow-hidden bg-[#eeedff] px-7 py-8 sm:px-12 lg:min-h-screen lg:px-16 lg:py-12">
          ...
          <div className="relative z-10 flex items-center gap-2 text-2xl font-extrabold tracking-[-0.05em] text-[#6252db]">Meateka<span className="mt-1 h-2 w-2 rounded-full bg-[#7d6ded]" /></div>
          <div className="relative z-10 flex flex-1 items-center py-12 lg:py-20"><div className="max-w-md"><p className="text-xs font-bold uppercase tracking-[0.2em] text-[#7164c9]">Content intelligence platform</p><h1 className="mt-5 text-4xl font-extrabold leading-[1.08] tracking-[-0.055em] text-[#242344] sm:text-5xl lg:text-6xl">Intelligence meets productivity.</h1><p className="mt-6 max-w-sm text-sm leading-7 text-[#686887] sm:text-base">Make every creative decision with more clarity. Meateka brings your ideas, audience signals, and growth strategy into one focused workspace.</p><div className="mt-8 flex items-center gap-3 text-xs font-semibold text-[#6252db]"><span className="h-px w-8 bg-[#958be5]" />Create with confidence</div></div></div>
        ...
        <section className="flex min-h-[620px] items-center justify-center bg-white px-6 py-14 sm:px-12 lg:px-16 lg:py-20">
          <div className="w-full max-w-[430px]">
            <div className="mb-10"><p className="text-xs font-bold uppercase tracking-[0.18em] text-[#7669d8]">Welcome back</p><h2 className="mt-3 text-3xl font-extrabold tracking-[-0.04em] text-[#20213c] sm:text-4xl">Sign in to Meateka</h2><p className="mt-3 text-sm leading-6 text-[#85869a]">Enter your details to continue to your content intelligence dashboard.</p></div>
            ...
            <div className="grid gap-3">
              ...
              <button type="button" onClick={handleDemoSignIn} className="flex h-12 w-full items-center justify-center rounded-xl border border-[#e3e1ef] bg-white px-4 text-xs font-semibold text-[#66677c] transition hover:border-[#c9c3f3] hover:bg-[#faf9ff]">Continue with demo account</button>
            </div>
            <p className="mt-7 text-center text-sm text-[#85869a]">Don&apos;t have an account? <Link to="/signup" className="font-bold text-[#7669d8] hover:text-[#5748c9]">Sign Up</Link></p>
          </div>
        </section>
      </div>
    </main>
