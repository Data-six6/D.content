...
export default function Pricing() {
  ...
  return <PageShell title="Pricing" description="Choose the tools that match the way you create and grow.">
    <div className="mx-auto max-w-5xl">
      ...
      <div className="mt-10 grid items-stretch gap-6 lg:grid-cols-2"><PricingCard name="Free" price="$0" description="For creators building a consistent publishing habit." current={!isPremium} disabled buttonLabel="Current Plan" onSelect={() => {}} features={["Up to 3 Content Plans", "Basic analytics dashboard", "50 saved ideas limit", "Standard support"]} /><PricingCard name="Pro" price={billing === "annual" ? "$23/mo" : "$29/mo"} description="For creators ready to turn content into momentum." popular current={isPremium} buttonLabel={isPremium ? "Change billing" : "Upgrade to Pro"} onSelect={startCheckout} features={["Unlimited Content Plans", "Advanced audience analytics & insights", "Unlimited saved ideas", "Priority 24/7 support", "Custom branding export"]} /></div>
    </div>
  </PageShell>;
}
